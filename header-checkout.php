    ...
    <header>
        <div class="nav-mobile">
            <div class="img-container">
                <img class="logo"src="http://mokaru.io/wp-content/uploads/2022/10/Group-57.png" alt="logo">
                <img class="logo-mobile" src="http://mokaru.io/wp-content/uploads/2022/07/Recurso-2.png" alt="logo-mobile">
            </div>
