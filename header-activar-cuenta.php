    ...
    <header>
        <div class="nav-mobile">
            <div class="img-container">
				<img class="logo" id="logoNava" src="http://mokaru.io/wp-content/uploads/2022/10/Group-57.png" alt="logo">
                <img class="logo-mobile" src="http://mokaru.io/wp-content/uploads/2022/12/Logo_ok.png" alt="logo-mobile">
            </div>

            <div class="toggle" id="toggleNav">
                <img src="http://mokaru.io/wp-content/uploads/2022/10/menu.png" alt="toggle">
            </div>
        </div>
        ...
        <div class="user-nav nav_Novisible" id="menuMovil">
			...
			<a class="salir" href="<?= $_SERVER["HTTP_REFERER"] ?>">
