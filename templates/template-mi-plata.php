...
<div class="grid transactions-view">
    ...
    <div class="primary-block" id="trans-action-block">
        ...
        <div class="button-container">
            <button type="button" class="depositar btn " data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="depositar-btn">Depositar  </button>                
            <button type="button" class="retirar btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="retirar-btn">Retirar  </button>                
        </div>
...
<div class="depositar-view noShow" id="depositar">
...
<div class="grid-retirar">
   ...
   <div class="salir" id="depositar-back">
...
<div class="retirar-view noShow" id="retirar">
