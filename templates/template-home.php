...
<div class="der">
    <h1>Llego el momento de cambiar tus <br><span>FINANZAS</span></h1>
    <p>En Mōkaru tus sueños son nuestros planes</p>


</div>

<div class="izq">
    <img src="http://mokaru.com.co/wp-content/uploads/2022/10/IPHONE-1.png" alt="Iphone">
</div>
...
<h2 class="section_cards">Conoce más de nuestros servicios Mōkaru</h2>
...
<h2 class="section_cards faqs">Preguntas Frecuentes</h2>
<div class="faq">
    <a href="/ayuda" class="preguntaLink">
        <p class="simbolo">?</p>
        <p class="pregunta">¿Cómo funciona Mōkaru?</p>
    </a>

    <a href="/ayuda" class="preguntaLink">
        <p class="simbolo">?</p>
        <p class="pregunta">¿Que puedo hacer con mi cuenta?</p>
    </a>

    <a href="/ayuda" class="preguntaLink">
        <p class="simbolo">?</p>
        <p class="pregunta">¿Cuando se habilitan los demás servicios?</p>
    </a>

    <a href="/ayuda" class="preguntaLink">
        <p class="simbolo">?</p>
        <p class="pregunta">¿Quiénes podrán acceder a Mokaru?</p>
    </a>

    <a href="/ayuda" class="preguntaLink">
        <p class="simbolo">?</p>
        <p class="pregunta">¿Es segura mi inversión?</p>
    </a>
</div>
