...
<section class="activa-tu-cuenta-content">
    <div id="insert">     
        ...
        if( $member->status == 'inactive' && $verify->show == false ){ ?>    
            <div class="bloque bloque-gold" style="display:block;">
                <div class="whrap-gold"> 
                    ...
                    <br>Generaras un 18% de interes en los siguientes 10 meses*. <br><br>Los fondos en tu <spam class="enfasis">Cuenta Mokaru Gold</spam> te generaran un <spam class="enfasis">2% de interes mensual despues de tu primera recarga.</spam> <br><br>Obtendras <spam class="enfasis">acceso exclusivo al fondo Mokaru</spam>, donde podras: <br> <br><ul><li>Diseñar tu plan de retiro a la medida</li><li>Crear lineas de ahorro <br></li></ul>
            ...
            <div class="bloque bloque-platinum" style="display:none;"><div class="whrap-platinum"> <h3>Estos son los beneficios que obtendras:</h3><p>En tu primer deposito de <spam class="platinum-txt usdt">500 USDT</spam> para la activacion de tu cuenta <spam class="platinum-txt usdt">Mokaru Platinum.</spam><br>Generaras un 18% de interes en los siguientes 10 meses*. <br><br>Los fondos en tu <spam class="enfasis">Cuenta Mokaru Platinum</spam> te generaran un <spam class="enfasis">2.5% de interes mensual despues de tu primera recarga.</spam> <br><br>Obtendras <spam class="enfasis">acceso exclusivo al fondo Mokaru</spam>, donde podras: <br> <br><ul><li>Diseñar tu plan de retiro a la medida</li><li>Crear lineas de ahorro <br></li></ul><br><spam class="txt-pequeño">$0 en costos por el manejo de tu Cuenta Mokaru y sin letras pequeñas, en Mokaru obtienes tu servicio tal como lo que quieres</spam> </p></div>
                <a href="<?=  $checkout_page_url ?>" class="guide-link platinum-txt">➝ Continua con tu deposito</a>
            </div>        
            <div class="bloque bloque-black" style="display:none;"><div class="whrap-black"> <h3>Estos son los beneficios que obtendras:</h3><p>En tu primer deposito de <spam class="black-txt usdt">1,000 USDT</spam> para la activacion de tu cuenta <spam class="black-txt usdt">Mokaru Black.</spam><br>Generaras un 18% de interes en los siguientes 10 meses*. <br><br>Los fondos en tu <spam class="enfasis">Cuenta Mokaru Black</spam> te generaran un <spam class="enfasis">3% de interes mensual despues de tu primera recarga.</spam> <br><br>Obtendras <spam class="enfasis">acceso exclusivo al fondo Mokaru</spam>, donde podras: <br> <br><ul><li>Diseñar tu plan de retiro a la medida</li><li>Crear lineas de ahorro <br></li></ul><br><spam class="txt-pequeño">$0 en costos por el manejo de tu Cuenta Mokaru y sin letras pequeñas, en Mokaru obtienes tu servicio tal como lo que quieres</spam> </p></div>
            ...
            <div class="info-adicional noShow" id="infoAdicional">
                ...
                <div class="info-header">
                    <img src="http://mokaru.io/wp-content/uploads/2022/10/Group-57.png" class="logo-info" alt="logo">
                ...
                <div class="info-whrap">
                    <p>El valor depositado para la activación de tu Cuenta Mokaru estará congelado por los próximos 10 meses generando un 18% de interés fijo; así podrás acceder de a los beneficios del fondo Mokaru: <br><br>
        ...
        <?php
        // SI LA PERSONA TIENE UN PEDIDO EN ESPERA
        }else{ ?>   
            <div class="bloque">
                <div class="whrap">
