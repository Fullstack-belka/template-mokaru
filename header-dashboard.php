	...
	<header class="header_dashboard" >
		<div class="nav-desktop">
			...
			<div class="menuWrap">
                    ...
                    <div class="navItem">
                        <a href="<?= get_permalink(325)?>" class="link-nav">
			...
			<div class="sub-menu-movil" id="sub-menu-movil">
				<ul class="movil-nav">
					<li class="movil-nav-li">
						<div class="logo-svg">
							<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M13.5 7.6001H21.5M21.5 7.6001V17.2001M21.5 7.6001L13.5 17.2001L9.5 12.4001L3.5 19.6001" stroke="#a7a7a7a7" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
								</svg>
					...
					<li class="movil-nav-li">                    
						...
						<a href="<?= get_permalink(325)?>" class="movil-sub-nav-li-a">Ayuda</a>
					</li>        
				</ul>            
			</div>                     
		</div>    
